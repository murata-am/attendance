...
@section('content')
    <div class="attendance_container">
        ...
        <div class="month-nav">
            <a href="{{ route('attendance.list', ['year' => $prevMonth['year'], 'month' => $prevMonth['month']]) }}" class="prev-month">← 前月</a>
            ...
            <a href="{{ route('attendance.list', ['year' => $nextMonth['year'], 'month' => $nextMonth['month']]) }}" class="next-month">翌月 →</a>
        </div>
